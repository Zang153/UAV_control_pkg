...
--tab -e 'bash -c "sleep 5; roslaunch vrpn_client_ros sample.launch server:=192.168.1.100; exec bash"' \
...
--tab -e 'bash -c "sleep 5; rosrun px4_command payload_quad; exec bash"' \
