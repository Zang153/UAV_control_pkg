...
class state_from_mavros
{
        ...
        state_nh("~")
    {
        ...
        position_sub = state_nh.subscribe<geometry_msgs::PoseStamped>("/vrpn_client_node/quad/pose", 10, &state_from_mavros::pos_cb,this);
    ...
    private:
        ...
        void pos_cb(const geometry_msgs::PoseStamped::ConstPtr &msg)
        {
            ...
            _DroneState.position[2] = msg->pose.position.z -0.10;
        }
