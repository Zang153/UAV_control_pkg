     ...
     float dt)
{
    ...
    _ControlOutput.Force[0] = thrust_sp[0];
    _ControlOutput.Force[1] = thrust_sp[1];
    _ControlOutput.Force[2] = thrust_sp[2];
     ...
     Eigen::Vector3d& thrust_sp)
{
    ...
    cout << "direction[X] ="  << thrust_sp[0] << endl;
    cout << "direction[Y] ="  << thrust_sp[1] << endl;
    cout << "direction[Z] ="  << thrust_sp[2] << endl;
